...
cd /d "%~dp0"
title Numerical Calculator - Web App

echo ============================================================
echo  Numerical Calculator - chay bang trinh duyet
echo ============================================================
echo.
...
echo.
echo [3/4] Dang cai/cap nhat thu vien can thiet...
...
echo sau do mo lai file RUN_APP.bat.
goto end

:venv_error
echo.
echo [LOI] Khong tao/kich hoat duoc moi truong ao .venv.
echo Thu xoa thu muc .venv trong project roi chay lai RUN_APP.bat.
goto end

:pip_error
echo.
echo [LOI] Cai thu vien that bai.
echo Kiem tra mang Internet, sau do chay lai RUN_APP.bat.
echo Neu may dang dung Python 3.13 va van loi, nen cai them Python 3.11.
goto end

:run_error
echo.
echo [LOI] Ung dung bi dung khi khoi dong.
echo Hay chup lai phan loi ngay phia tren va gui cho minh.
goto end
